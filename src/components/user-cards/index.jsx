    ...
    return (
        ...
        <button className="w-full py-3 px-4 flex gap-3 transition-colors hover:bg-[color:var(--background-third)]">
            ...
            <div className="flex flex-1  flex-col text-left">
                <div className=" flex gap-1 items-center text-[0.938rem]  font-bold leading-5 hover:underline hover:underline-offset-2 ">{user.fullName}
                    {user?.verified && (
                ...
                <div className="text-[0.938rem] text-[color:var(--color-base-secondary)] font-bold">{user.userName}
                </div>
