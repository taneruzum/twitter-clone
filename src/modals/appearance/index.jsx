    ...
    <div className="w-[600px] z-30">
      ...
      <div className="p-8 pt-0">
        ...
        <section className="mb-3">
          ...
          <div className="bg-[color:var(--background-secondary)] px-4 py-3 rounded-2xl flex justify-between items-center">
        ...
        <section className="mb-3">
          ...
          <div className="py-2 px-4 mb-3 grid gap-2 grid-cols-3 bg-[color:var(--background-secondary)] rounded-2xl">
            ...
            >
              ...
              {/* //* truncate: overflow-hidden , no-wrap, white-space bunların birleşimi */}
            </button>
          </div>
        </section>
