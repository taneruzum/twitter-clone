                ...
                <div className="flex p-3 ">
                    <div className="flex flex-col w-full gap-y-3">
                        <div className="relative px-3 pt-3 pb-2 border-[1px] border-[#38444d] rounded bg-[color:var(--background-primary)]">
                            <input className=" w-full  mt-1 text-[18px] bg-[color:var(--background-primary)] outline-none transition-all peer" type="text" id='inputField' />
                            <label htmlFor='inputField' id='label' className="absolute  left-3 top-1/2 -translate-y-1/2 text-lg text-[color:var(--color-base-secondary)] transition-all duration-100 transform   peer-focus:text-[color:var(--color-primary)]   peer-focus:scale-[75%] peer-focus:top-3 peer-focus:left-0 ">Seçenek 1</label>
                        </div>
                        <div className="relative px-3 pt-3 pb-2 border-[1px] border-[#38444d] rounded bg-[color:var(--background-primary)]">
                            <input className=" w-full  mt-1 text-[18px] bg-[color:var(--background-primary)] outline-none transition-all peer" type="text" id='inputField' />
                            <label htmlFor='inputField' id='label' className="absolute  left-3 top-1/2 -translate-y-1/2 text-lg text-[color:var(--color-base-secondary)] transition-all duration-100 transform   peer-focus:text-[color:var(--color-primary)]   peer-focus:scale-[75%] peer-focus:top-3 peer-focus:left-0 ">Seçenek 2</label>
                        </div>
                    </div>
