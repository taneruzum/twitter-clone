  ...
  return (
    <section className="bg-[color:var(--background-secondary)] mb-4 rounded-2xl border border-[color:var(--background-secondary)]">
      ...
      {more && (
        <Link
          to={more}
          className="w-full rounded-b-2xl h-[52px] flex items-center px-4 text-[15px] text-[color:var(--color-primary)] transition-colors hover:bg-[color:var(--background-third)] "
        >
          {" "}
          Daha fazla göster
        </Link>
