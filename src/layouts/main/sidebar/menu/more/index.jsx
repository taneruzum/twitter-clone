...
export default function More() {
  return (
    <Popover className="relative">
      <Popover.Button className="py-[1px] block group outline-none w-full text-left ">
      ...
      <Popover.Panel className="w-[318px] absolute bottom-0 left-0 bg-black shadow-box rounded-xl overflow-hidden">
        ...
        {/* buraya ince çizgi gelecek */}<Line width={100} />
        <Disclosure>
          ...
          <Disclosure.Panel>
            <Link
              to="/"
              className="text-white flex px-4 py-2 gap-x-2 font-medium text-[15px] items-center  hover:bg-[#eff3f41a] transition-colors"
            >
              <svg viewBox="0 0 24 24" width={18.75} height={18.75}>
                <g>
                  <path
        ...
        <Disclosure>
          ...
          <Disclosure.Panel className="text-white flex flex-col gap-2 font-medium text-[15px] items-start justify-center">
            <Link
              to="/"
